...
--
-- Table structure for table `classboard`
--

DROP TABLE IF EXISTS `classboard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `classboard` (
  `classboardkey` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`classboardkey`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `classboard`
--

LOCK TABLES `classboard` WRITE;
/*!40000 ALTER TABLE `classboard` DISABLE KEYS */;
/*!40000 ALTER TABLE `classboard` ENABLE KEYS */;
UNLOCK TABLES;
