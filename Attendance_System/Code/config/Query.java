...
public class Query {
 ...
 // RegisterPage /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static final String INSERT_REINFO_TABLE = "INSERT INTO user (user_id, user_idValue, user_password, user_name, user_birth, user_address, user_gender, user_phoneNum, user_major, class_name, profile_image, profile_name, profile_uploadName, profile_extension, profile_Size, class_num) "
          + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
