            ...
            if (i == buttonNames.length - 1) {
                ...
                button.addActionListener(e -> {
                    ...
                    if (result == JOptionPane.YES_OPTION) {
                    	...
                    	// 퇴실 등록
                    	AttendanceManager.getClassNameByUsername(username);
              ...
              button.addActionListener(e -> showPanel(new Profile_user(), layeredPane));    
            } else if (i == buttonNames.length - 5) {
//              button.addActionListener(e -> showPanel(new (), layeredPane));      
            } else if (i == buttonNames.length - 6) {
              button.addActionListener(e -> showPanel(new Counseling_user (), layeredPane));  
